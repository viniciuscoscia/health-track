				...
				<form class="container-fluid form-vertical" id="form-add-pressao" method="post" action="PressaoArterial?acao=insert">
					<div class="col-md-12">
						<div class="form-group col-md-6">
							...
							<input type="number" name="pressistolica" class="form-control" placeholder="A maior, em mmHg (Ex: 120)" id="pressistolica" required>
						</div>
						<div class="form-group col-md-6">
							<label>Pressão Diastólica:</label>
							<input type="number" name="pressdiastolica" id="pressdiastolica" class="form-control" placeholder="A menor, em mmHg (Ex: 80)" required>
						</div>
					</div>
					<div class="col-md-12">
